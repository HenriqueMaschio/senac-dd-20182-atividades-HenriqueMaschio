...
public class MenuFuncionario {
		...
		try {
			...
			while (opcaoMenuConsulta != OPCAO_SAIR_MENU_CONSULTA) {
				...
				case OPCAO_CONSULTA_TODOS_FUNCIONARIOS:
					...
					for(Funcionario	f: funcionarioDAO.ListarTodosFuncionarios()) {

						JOptionPane.showMessageDialog(null, "ID FUNCIONÁRIO: " + f.getIdFuncionario() +
								"NOME: " + f.getNome() + "CPF : " + f.getCpf() +
								"NÚMERO DE MATRICULA: " + f.getNumeroMatricula());						}
					break;
	...
	private void cadastrarFuncionario() {
		...
		funcionario.setNumeroMatricula(JOptionPane.showInputDialog("Número da matricula: "));
